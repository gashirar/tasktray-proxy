...
import (
	"flag"
	"fmt"
	"github.com/gashirar/tasktray-proxy/pkg/icon"
	"github.com/gashirar/tasktray-proxy/pkg/proxyconfig"
	"github.com/gashirar/tasktray-proxy/pkg/proxyserver"
	"github.com/gashirar/tasktray-proxy/pkg/wifiname"
